    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ResumeBank.Repository.RBDbContext>
    {
        ...
        protected override void Seed(ResumeBank.Repository.RBDbContext context)
        {
            ...
            context.Categories.AddOrUpdate(c => c.Id,
                ...
                new Category() { Id = 3, Name = "Bank/ Non-Bank Fin. Institution", UpdatedAt = DateTime.Today },
                new Category() { Id = 4, Name = "Beauty Care/ Health & Fitness", UpdatedAt = DateTime.Today },
                new Category() { Id = 5, Name = "Commercial/Supply Chain", UpdatedAt = DateTime.Today },
                new Category() { Id = 6, Name = "Customer Support/Call Centre", UpdatedAt = DateTime.Today },
                new Category() { Id = 7, Name = "Data Entry/Operator/BPO", UpdatedAt = DateTime.Today },
                new Category() { Id = 8, Name = "Design/Creative", UpdatedAt = DateTime.Today },
                new Category() { Id = 9, Name = "Driving/Motor Technician", UpdatedAt = DateTime.Today },
                new Category() { Id = 10, Name = "Education/Training", UpdatedAt = DateTime.Today },
                new Category() { Id = 11, Name = "Electrician/ Construction/ Repair", UpdatedAt = DateTime.Today },
                new Category() { Id = 12, Name = "Engineer/Architects", UpdatedAt = DateTime.Today },
                new Category() { Id = 13, Name = "Garments/Textile", UpdatedAt = DateTime.Today },
                new Category() { Id = 14, Name = "Gen Mgt/Admin", UpdatedAt = DateTime.Today },
                new Category() { Id = 15, Name = "Hospitality/ Travel/ Tourism", UpdatedAt = DateTime.Today },
                ...
                new Category() { Id = 23, Name = "Production/Operation", UpdatedAt = DateTime.Today },
                new Category() { Id = 24, Name = "Research/Consultancy", UpdatedAt = DateTime.Today },
                new Category() { Id = 25, Name = "Secretary/Receptionist", UpdatedAt = DateTime.Today },
                new Category() { Id = 26, Name = "Security/Support Service", UpdatedAt = DateTime.Today },
